...
rm -f %{buildroot}/usr/lib/python3*/site-packages/azure/cli/command_modules/__init__.py
rm -f %{buildroot}/usr/lib/python3*/site-packages/azure/cli/command_modules/__pycache__/__init__.cpython-3*.pyc
